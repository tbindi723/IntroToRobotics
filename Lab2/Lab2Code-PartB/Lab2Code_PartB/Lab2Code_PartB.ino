...
#define DistancePerRev      27.0 // Distance in CM per wheel revolution
...
#define deadband_A 60 //(Right)
#define deadband_B 30 //(Left)

#define turnDeadband_A 45 //(Right)
#define turnDeadband_B 35 //(Left)
