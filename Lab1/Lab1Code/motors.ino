// Other .ino files in the same folder do not need to be imported
// Allows for clean definition of auxilliary functions
// These motor control functions are included and don't need to be modified.

void motor_setup() {
  // Sets up motor using pins defined in lab code
...
void run_motor(int motor, int pwm) {
  ...
  // A negative pwm reverses direction.
